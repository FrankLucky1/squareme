...
export default function Home() {
  ...
  if (error) {
    ...
    return (
      <div className="flex flex-col items-center justify-center max-h-[200px] mt-4 p-4 sm:p-4 w-full max-sm:w-[80%] max-w-sm mx-auto bg-[#ffe6d3] text-[#ff892f] rounded-lg shadow-lg">
